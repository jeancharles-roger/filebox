...
public class JBoost implements Boost {
	 ...
	 * </p>
	 */
	// protected final Map<IBoostObject, Integer> objectsToSave = new
	// HashMap<IBoostObject, Integer>();
	/**
	 * <p>
	...
	/* (non-Javadoc)
	 * @see com.geensys.tinymodel.Boost#setErrorHandler(com.geensys.tinymodel.IErrorHandler)
	 */
	...
	/**
	 * @return the {@link JBoost} encoding
	 */
	...
	/* (non-Javadoc)
	 * @see com.geensys.tinymodel.Boost#writeObject(com.geensys.tinymodel.IBoostObject)
	 */
